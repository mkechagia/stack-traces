...
def main():
	...
	api_methods_stacktraces_path2 = "/Users/marki/Desktop/stackoverflow_bugs/api-methods.txt"
	api_methods_stacktraces_path3 = "/Users/marki/Desktop/android_methods.txt"
	api_methods_stacktraces_path = "/Users/marki/Desktop/java_methods.txt"
	...
	# find common methods in API source code, stack overflow, and signatures
	...
	#print stacktrace_methods.keys()
	#compare_stacktrace_stackoverflow_methods()
	...
	#compare_stacktrace_bugs_methods()
...
def read_stackoverflow_methods(path):
	...
	print "no of methods (duplicates) in stackoverflow: ", c
...
def compare_stacktrace_stackoverflow_methods():
	...
	keys = stackoverflow_methods.keys()
...
def read_stackoverflow_pairs(path):
	...
	print "no of pairs with api methods: ", c
	#print pairs
...
def read_bugs_methods(path):
	...
	print "no of distinct methods in bugs:", len(bugs_methods.keys())
